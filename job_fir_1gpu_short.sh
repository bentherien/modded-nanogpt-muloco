...
#SBATCH --time=3:00:00
#SBATCH --job-name=muloco_1gpu_s
#SBATCH --output=logs/slurm_%j.out
#SBATCH --error=logs/slurm_%j.err

# Short 3-hour 1-GPU job - better for backfill scheduling
...
echo "Starting 1-GPU sweep (short): olr=$OUTER_LR omom=$OUTER_MOMENTUM H=$SYNC_INTERVAL"
